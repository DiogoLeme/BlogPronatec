<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
 ...
 <jsp:include page="cabecalho.jsp" />
       ...
       <form class="form-signin" action="usuario" method="post">
        ...
        <input type="text" value="${usuario.nome}"  name="nome" class="form-control top" placeholder="Nome" autofocus>
        <input type="text" value="${usuario.sobrenome}" name="sobrenome" class="form-control center" placeholder="Sobrenome">
        <input type="text" value="${usuario.email}" name="email" class="form-control bottom" placeholder="Email">
